...
function SurveyForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Using your specific Apps Script URL
    ...
    try {
      // Method 1: Send as URL-encoded form data
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex justify-between mb-1">
          <p className="text-sm font-medium text-gray-300">Step {currentStep} of {totalSteps}</p>
          <p className="text-sm font-medium text-gray-300">{Math.round(progress)}% Complete</p>
        </div>
        ...
        >
          {status ? (
            <div className="py-10 text-center">
              ...
              <p className="mt-6 text-gray-400">One of our debt specialists will contact you shortly.</p>
            </div>
          ) : (
            <>
              <h3 className="text-2xl font-bold text-white mb-6">{questions[currentStep-1]}</h3>
              ...
              <div className="space-y-4">
                <input
                  ...
                  required
                  disabled={isLoading}
                  className="w-full p-4 bg-gray-700 border border-gray-600 rounded-lg text-white text-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all placeholder-gray-400"
                  ...
                  <div className="flex gap-3 mt-4">
                    <button
                      ...
                      className={`flex-1 p-4 rounded-lg text-lg font-medium transition-all ${
                        q3 === "Yes" ? "bg-blue-600 text-white" : "bg-gray-700 text-gray-300 hover:bg-gray-600"
                      }`}
                    >
                      Yes
                    </button>
                    <button
                      ...
                      onClick={() => setQ3("No")}
                      className={`flex-1 p-4 rounded-lg text-lg font-medium transition-all ${
                        q3 === "No" ? "bg-blue-600 text-white" : "bg-gray-700 text-gray-300 hover:bg-gray-600"
                      }`}
                    >
                      No
                    </button>
                    ...
                    {["Employed", "Self-employed", "Unemployed", "Retired"].map((option) => (
                      <button
                        ...
                        className={`p-4 rounded-lg text-center text-lg font-medium transition-all ${
                          q4 === option ? "bg-blue-600 text-white" : "bg-gray-700 text-gray-300 hover:bg-gray-600"
                        }`}
                      >
                        {option}
                      </button>
