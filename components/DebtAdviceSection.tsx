        ...
        <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md mx-auto space-y-6 mb-12 md:mb-0 md:mx-0">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-[#1B4D3E] text-white text-center font-semibold py-3 rounded-full hover:bg-[#164037] transition shadow-md"
              aria-label="Send Enquiry"
            >
              {/* Button Text: Applied typography (implicitly via font-semibold, other styles from prompt are for labels/headings) */}
              SEND ENQUIRY
            </Button>
          </form>
        </div>
